...
pub fn log_hot_cells(limit: usize) {
    ...
    if snapshots.is_empty() {
        log::info!("[hypha-trace] no traced cells recorded yet");
        return;
    }

    log::info!("[hypha-trace] top {} hot cells:", snapshots.len());
    for snapshot in snapshots {
        ...
        log::info!(
            "[hypha-trace] name={} notify_count={} total_ms={:.3} last_ms={:.3} slowest_sub_ms={:.3} subscribers={} owned={} caller={}",
            name,
