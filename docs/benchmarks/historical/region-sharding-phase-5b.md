...
Complete verbatim stdout/stderr is available at the retention commit named above. Commands appear in this report; all benchmark processes used the exact invocation above with the recorded worker value.
