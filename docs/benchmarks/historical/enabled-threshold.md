...
> Retention note: the raw captures referenced below are available from Git commit `4465c6dbe364bfee9f97136d64420549af14d800`. The current tree retains this decision record and its derived estimates.
...
used. [`data/enabled-threshold-estimates.csv`](data/enabled-threshold-estimates.csv)
records the selected estimator exactly.
