...
Verbatim stdout/stderr, all Criterion `benchmark.json`, `sample.json`, `estimates.json`, and `tukey.json`, derived CSVs, commands/environment manifest, and deterministic hashes are stored in this directory.
